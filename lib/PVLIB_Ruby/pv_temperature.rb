...
class PvTemperature
  ...
  def initialize(pv_module)
    @pv_module = pv_module
  end

  def cell_temperature(solar_irradiance_incident_on_module_surface, reference_solar_irradiance, wind_speed, air_temperature)
    module_temperature(solar_irradiance_incident_on_module_surface, wind_speed, air_temperature) + 
  ...
  def module_temperature(solar_irradiance_incident_on_module_surface, wind_speed, air_temperature)
